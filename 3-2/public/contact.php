...
include("../php_actions/contact_action.php");
?>
<!DOCTYPE html>
<html lang = "fa">
<head>
        ...
        <div class="form-container form-user">
            ...
            <form class="form-vertical" method="get" action=<?= $_SERVER["PHP_SELF"]?>>
                ...
                <div class="form-group m-1 h-auto flex-100">
                    <select class="form-control form-control-select control-filled h-2"  value="" name="message-title" id="message-title">
                ...
                <div class="form-group m-1 h-auto flex-50">
                    <input type="email" class="form-control form-control-input control-filled h-2" value="" name="email" id="email" aria-labelledby="email-placeholder">
                    <label class="placeholder" for="email" id ="email-placeholder" >ایمیل</label>
                    <div class="error-message" id="email-error"><?=$emailError?></div>
                </div>

                <div class="form-group m-1 h-auto flex-100">
                    <textarea class="form-control form-control-textarea control-filled h-auto" value="" name="message" id="message" aria-labelledby="message-placeholder"></textarea>
