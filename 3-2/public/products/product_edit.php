        ...
        <div class="form-container">
            ...
            <form class="form-vertical" method="post" action=<?= $_SERVER["PHP_SELF"]?>>
                ...
                <div class="form-group m-1 h-auto flex-50">
                    <select class="form-control form-control-select control-outlined h-2"  value="" name="type" id="type">
                ...
                <div class="form-group m-1 h-auto flex-50">
                    <select class="form-control form-control-select control-outlined h-2"  value="" name="state" id="state">
                ...
                <div class="form-group m-1 h-auto flex-50">
                    <input type="text" class="form-control form-control-input control-outlined h-2" value="" name="name" id="name" aria-labelledby="name-placeholder">
                ...
                <div class="form-group m-1 h-auto flex-50">
                    <input type="text" step="any" class="form-control form-control-input control-outlined h-2" value="" name="price" id="price" aria-labelledby="price-placeholder">
                ...
                <div class="form-group m-1 h-auto flex-100">
                    <textarea class="form-control form-control-textarea control-outlined h-auto" value="" name="description" id="description" aria-labelledby="description-placeholder"></textarea>
